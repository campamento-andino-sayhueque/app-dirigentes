...
interface CalendarioViewProps {
  ...
  loading: boolean;
  onSelectEvent: (event: CalendarEventFormatted) => void;
}

export function CalendarioView({ events, loading, onSelectEvent }: CalendarioViewProps) {
  ...
  const eventStyleGetter = useCallback((event: CalendarEventFormatted) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg">
      ...
      {/* 
        IMPORTANT: Casting events to 'any' here is a workaround because react-big-calendar types 
        can be strict about the Event interface. CalendarEventFormatted matches the shape but 
        TS sometimes complains.
      */}
      <Calendar
        localizer={localizer}
        ...
        onSelectEvent={(e) => onSelectEvent(e as CalendarEventFormatted)}
