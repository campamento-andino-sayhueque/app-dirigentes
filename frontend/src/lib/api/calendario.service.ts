 ...
 */
function toCalendarEvent(evento: EventoCalendarioModel): CalendarEventFormatted {
  return {
    id: String(evento.id),
    title: evento.titulo,
 ...
 */
function toCalendarEvents(eventos: EventoCalendarioModel[]): CalendarEventFormatted[] {
...
export const calendarioService = {
   ...
   */
  async getEventosMes(year: number, month: number): Promise<ApiResult<EventosCollection>> {
   ...
   */
  async getProximosEventos(dias: number = 30): Promise<ApiResult<EventosCollection>> {
